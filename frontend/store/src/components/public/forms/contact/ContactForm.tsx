            ...
            <div className="col-md-8 col-lg-8 pb-4">
              <div className="row mb-5">
                <div className="col-lg-4">
                  <div className={styles.service + " no-shadow align-items-center link horizontal d-flex active"} data-aos="fade-left" data-aos-delay="0">
                    <div className={styles.serviceIcon + " color-1 mb-4"} >
