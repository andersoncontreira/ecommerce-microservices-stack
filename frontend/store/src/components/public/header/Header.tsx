    ...
    return (
        ...
        <nav className={style.customNavbar + " navbar navbar navbar-expand-md navbar-dark bg-dark"} arial-label="Furni navigation bar">
            ...
            <div className="container">
                <a className="navbar-brand" href="/index">Furni<span>.</span></a>

                <button className={style.navbarToggler} type="button" data-bs-toggle="collapse" data-bs-target="#navbarsFurni" aria-controls="navbarsFurni" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div className="collapse navbar-collapse" id="navbarsFurni">
                    ...
                    <ul className="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                        <li><a className="nav-link" href="/user"><img src={userImg} /></a></li>
